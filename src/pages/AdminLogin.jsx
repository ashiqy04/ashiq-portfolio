  ...
  return (
    <div className="wrap" style={{ maxWidth: 380, paddingTop: 100 }}>
      <div className="terminal-line">
        <span className="prompt">$</span> sudo login
      </div>
      <h1 className="section-title" style={{ marginBottom: 24 }}>Admin</h1>

      <button className="btn btn-primary google-btn" onClick={handleClick} disabled={submitting}>
        <GoogleIcon />
